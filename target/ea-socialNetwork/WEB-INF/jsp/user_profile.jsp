            ...
            <div class="cm-timelines">
                ...
                <div class="cm-timeline row">
                    ...
                    <div class="row cm-peep cm-peep-up">
                        ...
                        <div class="cmp-btn">
                            <button class="btn btn-sm btn-outline-info btn-rounded float-right" type="submit"><spring:message code="Userprofile.Follow"/></button>
                        </div>
                    </div>
                          ...
                          <div class="container cmtt-comments">
                            ...
                            <div class="row cmttc-otherComments" >
                              ...
                              <div class="col-9 cmttco-cmt">
                                  <p><spring:message code="index.This.is.a.comment.from.me"/></p>
                              </div>
                            </div>
                        </div>
                      </span>
