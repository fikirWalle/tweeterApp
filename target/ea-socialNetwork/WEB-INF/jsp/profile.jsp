...
<jsp:include page="/WEB-INF/jsp/includes/timeline-header.jsp"></jsp:include>
        ...
        <div class="col-md-6 col-sm-10 c-main">
            <h5 class="cm-title"><spring:message code="index.personal.profile"/></h5>
                ...
                <div class="cm-timeline row">
                    <div class="row cm-peep cm-peep-up">
                        ...
                        <div class="cmp-profile">
                            ...
                            <button type="submit" ><spring:message code="index.change.up"/></button>

                        </div>
                        <div class="cmp-btn">
                            <button class="btn btn-sm blue-gradient btn-rounded float-right" type="submit"
                                    data-toggle="modal" data-target="#editModal"><spring:message code="user.edit.profile"/>Edit profile</button>
                        </div>
                    </div>
