                    ...
                    <div class="card-body">
                        ...
                        <table id="table_id" class="display table table-striped">
                            ...
                            <tr>
                                ...
                                <th><spring:message code="user.account.creation.date"/></th>
                                <th><spring:message code="user.account.yob"/></th>
                                <th><spring:message code="user.account.Email"/></th>
                                <th><spring:message code="user.account.status"/></th>
                                <th><spring:message code="user.account.action"/>(s)</th>
