        ...
        <div class="container-fluid mt-5">
            <div class="row wow fadeIn">
                ...
                <div class="col-md-12 mb-4">
                    ...
                    <!--Card-->
                    <div class="card">
                        <div class="h5 card-header text-center"><spring:message code="Filthy.posts"/></div>
                        <!--Card content-->
                        <div class="card-body">
                            ...
                            <table id="table_id" class="display table table-striped">
                                ...
                                <tr>
                                    <th>#</th>
                                    <th><spring:message code="Filthy.Date"/></th>
                                    <th><spring:message code="Filthy.poster"/></th>
                                    <th><spring:message code="Filthy.Filthy.texts"/></th>
                                    <th class="text-center"><spring:message code="Filthy.Filthy.Actions"/></th>
                                </tr>
                                </thead>
                                <!-- Table head -->
