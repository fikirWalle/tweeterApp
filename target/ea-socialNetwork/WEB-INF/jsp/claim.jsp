...
<jsp:include page="/WEB-INF/jsp/includes/claim-header.jsp"></jsp:include>
        ...
        <div class="col-md-6 col-sm-10 c-main">
            <h5 class="cm-title text-center text-danger text-uppercase"><spring:message code="timeline.Account.Locked"/></h5>
            ...
            <div class="cm-timelines">
                ...
                <div class="cm-timeline row">
                    ...
                    <div class="row cm-peep cm-peep-up">
                        ...
                        <div class="cmp-btn">
                            <button class="btn btn-sm btn-outline-danger float-right" type="submit" data-toggle="modal" data-target="#claimModal"><spring:message code="timeline.Claim.Account"/></button>
                        </div>
                    </div>
    ...
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><spring:message code="timeline.Claim.Account"/></h5>
                ...
                <form method="post" action="">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="md-form mb-0">
                                ...
                                <label for="name"><spring:message code="timeline.Claim.name"/></label>
                            </div>
                        </div>
                    </div>
                    <!--Grid row-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="md-form">
                                <label for="reason"><spring:message code="timeline.Claim.message"/></label>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-outline-primary"><spring:message code="timeline.send.claim"/></button>
            </div>
        </div>
    </div>
</div>
