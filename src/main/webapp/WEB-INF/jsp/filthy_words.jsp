        ...
        <div class="container-fluid mt-5">
           <div class="row float-right">
               <button class="btn blue-gradient btn-rounded p-3" type="button" data-toggle="modal" data-target="#addModal">
                   <i class="fa fa-plus-square"></i><spring:message code="filtiy.Add.New"/> Add new
               </button>
           </div>
            ...
            <div class="row wow fadeIn" style="clear: both;">
                ...
                <div class="col-md-12 mb-4">
                    ...
                    <!--Card-->
                    <div class="card">
                        <div class="h5 card-header text-center"><spring:message code="timeline.Filthy.Words"/></div>
                        <!--Card content-->
                        <div class="card-body">
                            ...
                            <table id="table_id" class="display table table-striped">
                                ...
                                <tr>
                                    <th>#</th>
                                    <th><spring:message code="filtiy.Words"/>Word</th>
                                    <th>Meaning</th>
                                    <th class="text-center"><spring:message code="Fitiy.Action"/></th>
                                </tr>
                                </thead>
                                <!-- Table head -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><spring:message code="timeline.new.Filthy.Words"/></h5>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="md-form mb-0">
                                ...
                                <label for="word"><spring:message code="Filthy.Words"/></label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="md-form">
                                ...
                                <label for="meaning"><spring:message code="Filthy.Words.meaning"/></label>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal"><spring:message code="Filthy.close"/></button>
                <button type="button" class="btn btn-primary"><spring:message code="Filthy.add"/></button>
                    <div class="modal-footer">
