...
public class PostController {
    ...
    @GetMapping("/comment")
    public @ResponseBody String comment(@RequestParam("content") String content, @RequestParam("commentToId") Long commentToId,
                                        @AuthenticationPrincipal UserPrincipal userPrincipal) {
        Post post = new Post();
        post.setCommentTo(postService.findById(commentToId));
